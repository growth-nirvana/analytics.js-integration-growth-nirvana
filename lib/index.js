...
/**
 * messages can be a maximum of 32kb.
 */
...
/**
 * Expose `GrowthNirvana` integration.
 */

var GrowthNirvana = (exports = module.exports = integration('GrowthNirvana')
  .option('apiKey', '')
  .option('apiHost', 'gn-analytics-engine.herokuapp.com/app_events')
...
GrowthNirvana.prototype.initialize = function() {
  var self = this;

  if (this.options.retryQueue) {
    this._lsqueue = new Queue('growthnirvana', queueOptions, function(elem, done) {
      ...
      GrowthNirvana.sendJsonWithTimeout(
        item.url,
        item.msg,
        item.headers,
        10 * 1000,
...
GrowthNirvana.prototype.loaded = function() {
  return true;
};
...
GrowthNirvana.prototype.onpage = function(page) {
  console.log('inside the page call')
...
GrowthNirvana.prototype.onidentify = function(identify) {
...
GrowthNirvana.prototype.ongroup = function(group) {
...
GrowthNirvana.prototype.ontrack = function(track) {
  var json = track.json();
  delete json.traits;
  this.enqueue('/t', json);
};
...
GrowthNirvana.prototype.onalias = function(alias) {
  var json = alias.json();
...
GrowthNirvana.prototype.normalize = function(message) {
  var msg = message;
...
GrowthNirvana.prototype.ampId = function(ctx) {
...
GrowthNirvana.prototype.enqueue = function(path, message, fn) {
...
GrowthNirvana.prototype.cookie = function(name, val) {
  var store = GrowthNirvana.storage();
...
GrowthNirvana.prototype.referrerId = function(query, ctx) {
 ...
 * @api private
 */
GrowthNirvana.prototype.isCrossDomainAnalyticsEnabled = function() {
 ...
 */
GrowthNirvana.prototype.retrieveCrossDomainId = function(callback) {
  if (!this.isCrossDomainAnalyticsEnabled()) {
 ...
 */
GrowthNirvana.prototype.getCachedCrossDomainId = function() {
 ...
 * @api private
 */
GrowthNirvana.prototype.saveCrossDomainId = function(crossDomainId) {
  if (!this.options.saveCrossDomainIdInLocalStorage) {
 ...
 * @api private
 */
GrowthNirvana.prototype.deleteCrossDomainIdIfNeeded = function() {
